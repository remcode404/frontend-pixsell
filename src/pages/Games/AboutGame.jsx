            ...
            if (index !== 0) {
              return (
                <Carousel.Item key={item}>
                  <img src={`http://localhost:3001/${item}`} alt="img" className="d-block w-100" />
                </Carousel.Item>
              );
            }
          })}
          ...
          {isExistenceReview ? <p> Вы уже добавили отзыв</p> :(
            <div className={style.add_review}>
              ...
              <div className={style.buttons}>
                <button className={style.like_btn} onClick={() => setIsGrade(true)}>
                  Хорошо{' '}
                  <svg
                    width="34"
                    height="34"
                ...
                <button className={style.dislike_btn} onClick={() => setIsGrade(false)}>
                  Плохо{' '}
                  <svg
                    width="34"
                    height="34"
